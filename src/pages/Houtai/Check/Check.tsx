...
api_register.interceptors.request.use(
  config => {
...
const fetchPendingPosts = async () => {
  try {
    const response = await api_register.get(
      'http://116.198.207.159:12349/api/audit/question/posts'
    )
...
const fetchPendingUpdateRequests = async () => {
  try {
    const response = await api_register.get(
      'http://116.198.207.159:12349/api/audit/update/requests'
    )
    const data = response.data
...
const fetchPendingAnswers = async () => {
  try {
    const response = await api_register.get(
      'http://116.198.207.159:12349/api/audit/answer'
    )
    const data = response.data

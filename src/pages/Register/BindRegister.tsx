      ...
      <div className={style.body}>
        ...
        <div className="specialBox mt-[2rem] flex justify-center items-center h-[20rem] w-[24rem]">
          <div className="flex flex-col rounded gap-2">
            ...
            {isEmailSent ? (
              <p className="text-normal text-base text-white">验证邮件已发送，请前往邮箱完成验证。</p>
            ) : (
              <>
            ...
            <p className="mt-[10px] text-normal text-xs text-white">已经有账号？<Link to="/login" className="text-normal text-xs text-white">去登录</Link></p>
